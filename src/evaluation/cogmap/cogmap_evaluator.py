...
class CogMapEvaluator:
    ...
    def _extract_cognitive_map(self, cogmap_answer: str, item: Dict, cogmap_field: str, 
                              item_id: str, error_cases: Dict) -> Optional[Dict]:
    ...
    def _update_similarity_metrics(self, similarity: Dict, results: Dict, setting: str, 
                                  total_metrics: Dict, include_in_overall: bool):
