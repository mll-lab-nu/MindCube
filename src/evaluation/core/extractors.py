"""
Core extraction utilities for answers and JSON from model responses.

This module provides functions to:
1. Extract answers from text responses (A, B, C, D, E format)
2. Extract JSON from text responses 
3. Basic JSON validation and cleanup
"""
